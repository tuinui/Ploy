...
public class ChangePasswordFragment extends BaseFragment implements View.OnClickListener {
    ...
    @BindView(R.id.button_change_password_confirm)
    Button mButtonConfirm;
    //    @BindView(R.id.edittext_change_password_email_address)
//    MaterialEditText mEditTextEmail;
    @BindView(R.id.edittext_change_password_new_password)
    MaterialEditText mEditTextPassword;
    @BindView(R.id.edittext_change_password_re_password)
    ...
    protected void bindLanguage(LanguageAppLabelGson.Data data) {
        ...
        mTextViewTitle.setText(data.accountScreenResetpassHeader);
    }
...
//        String email = extractAndCheckError(mEditTextEmail);
        final String password = extractAndCheckError(mEditTextPassword);
...
*/
        ...
        if (canSubmit) {
            if (TextUtils.equals(password, rePassword)) {
                ...
                AccountGson.Data account = SharePreferenceUtils.getAccountGson(getContext());
                if (null != account) {
                    requestForgotPassword(new PostForgotPasswordGson(account.getEmail(), password));
                }
            } else {
