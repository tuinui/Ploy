...
public class PloyerCategoryRecyclerAdapter extends SortedListAdapter<PloyerServicesGson.Data> {
    private final Action1<PloyerServicesGson.Data> mActionOnClick;

    //    public PloyerCategoryRecyclerAdapter(Context context, Class<PloyerServicesGson.Data> itemClass, Comparator<PloyerServicesGson.Data> comparator) {
//        super(context, itemClass, comparator);
//    }
    public PloyerCategoryRecyclerAdapter(Context context, Comparator<PloyerServicesGson.Data> comparator, Action1<PloyerServicesGson.Data> actionOnClick) {
...
//    }
    ...
    public class ViewHolder extends SortedListAdapter.ViewHolder<PloyerServicesGson.Data> {
        ...
        @Override
        protected void performBind(PloyerServicesGson.Data data) {
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    IntentUtils.startActivity(view.getContext(), PloyeeListActivity.class);
                }
            });
